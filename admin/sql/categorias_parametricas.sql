...
-- Tiempo de generación: 12-12-2018 a las 11:48:50
...
--
-- Estructura de tabla para la tabla `categorias_parametricas`
--

CREATE TABLE `categorias_parametricas` (
...
--
-- Volcado de datos para la tabla `categorias_parametricas`
--

INSERT INTO `categorias_parametricas` (`id_categoria_parametrica`, `tipo`, `nombre`, `estado`) VALUES
(1, 1, 'AREA', 1),
(2, 2, 'Unidad de Negocio', 1),
(3, 3, 'Estados de Proyectos', 1),
(4, 4, 'TIPO', 1),
(5, 5, 'P.O. N°', 1),
(6, 6, 'TIPO DOCUMENTOS', 1),
(7, 7, 'LICENCIAS', 1);
...
--
-- Indices de la tabla `categorias_parametricas`
--
ALTER TABLE `categorias_parametricas`
  ADD PRIMARY KEY (`id_categoria_parametrica`);
...
--
-- AUTO_INCREMENT de la tabla `categorias_parametricas`
--
ALTER TABLE `categorias_parametricas`
  MODIFY `id_categoria_parametrica` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
COMMIT;
